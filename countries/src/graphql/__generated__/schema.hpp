...
class Continent : public qtgql::bases::ObjectTypeABC {
  Q_OBJECT
public:
  qtgql::bases::scalars::Id m_code = qtgql::bases::DEFAULTS::ID;
...
public:
  ...
  [[nodiscard]] const std::vector<std::shared_ptr<Country>> &
  get_countries() const {
    return m_countries;
  }
...
class Country : public qtgql::bases::ObjectTypeABC {
  Q_OBJECT
public:
  QString m_awsRegion = qtgql::bases::DEFAULTS::STRING;
  QString m_capital = qtgql::bases::DEFAULTS::STRING;
  qtgql::bases::scalars::Id m_code = qtgql::bases::DEFAULTS::ID;
  std::shared_ptr<Continent> m_continent = {};
  std::shared_ptr<qtgql::bases::ListModelABC<QString>> m_currencies = {};
  QString m_currency = qtgql::bases::DEFAULTS::STRING;
  QString m_emoji = qtgql::bases::DEFAULTS::STRING;
  QString m_emojiU = qtgql::bases::DEFAULTS::STRING;
  std::vector<std::shared_ptr<Language>> m_languages = {};
  std::map<std::tuple<QString>, QString> m_name = {};
  QString m_native = qtgql::bases::DEFAULTS::STRING;
  QString m_phone = qtgql::bases::DEFAULTS::STRING;
  std::shared_ptr<qtgql::bases::ListModelABC<QString>> m_phones = {};
  std::vector<std::shared_ptr<State>> m_states = {};
  std::vector<std::shared_ptr<Subdivision>> m_subdivisions = {};
...
public:
  [[nodiscard]] const QString &get_awsRegion() const { return m_awsRegion; }
  void set_awsRegion(const QString &v) {
    m_awsRegion = v;
    emit awsRegionChanged();
  };

  [[nodiscard]] const QString &get_capital() const { return m_capital; }
  ...
  [[nodiscard]] const std::shared_ptr<qtgql::bases::ListModelABC<QString>> &
  get_currencies() const {
    return m_currencies;
  }
  void set_currencies(
      const std::shared_ptr<qtgql::bases::ListModelABC<QString>> &v) {
    m_currencies = v;
    emit currenciesChanged();
  };

  [[nodiscard]] const QString &get_currency() const { return m_currency; }
  void set_currency(const QString &v) {
    m_currency = v;
    emit currencyChanged();
  };

  [[nodiscard]] const QString &get_emoji() const { return m_emoji; }
  void set_emoji(const QString &v) {
    m_emoji = v;
    emit emojiChanged();
  };

  [[nodiscard]] const QString &get_emojiU() const { return m_emojiU; }
  void set_emojiU(const QString &v) {
    m_emojiU = v;
    emit emojiUChanged();
  };

  [[nodiscard]] const std::vector<std::shared_ptr<Language>> &
  get_languages() const {
    return m_languages;
  }
  ...
  [[nodiscard]] const QString &get_native() const { return m_native; }
  void set_native(const QString &v) {
    m_native = v;
    emit nativeChanged();
  };

  [[nodiscard]] const QString &get_phone() const { return m_phone; }
  ...
  void
  set_phones(const std::shared_ptr<qtgql::bases::ListModelABC<QString>> &v) {
    m_phones = v;
    emit phonesChanged();
  };
  ...
  [[nodiscard]] const std::vector<std::shared_ptr<Subdivision>> &
...
public:
  ...
  QString m_name = qtgql::bases::DEFAULTS::STRING;
  QString m_native = qtgql::bases::DEFAULTS::STRING;
  bool m_rtl = qtgql::bases::DEFAULTS::BOOL;
...
public:
  ...
  [[nodiscard]] const bool &get_rtl() const { return m_rtl; }
...
public:
  std::map<std::tuple<qtgql::bases::scalars::Id>, std::shared_ptr<Continent>>
      m_continent = {};
  std::map<std::tuple<ContinentFilterInput>,
           std::vector<std::shared_ptr<Continent>>>
      m_continents = {};
...
public:
  [[nodiscard]] const std::shared_ptr<Continent> &
  get_continent(std::tuple<qtgql::bases::scalars::Id> args) const {
    return m_continent.at(args);
  }
  void set_continent(const std::shared_ptr<Continent> &v,
                     std::tuple<qtgql::bases::scalars::Id> args) {
    m_continent[args] = v;
    emit continentChanged();
  };

  [[nodiscard]] const std::vector<std::shared_ptr<Continent>> &
  get_continents(std::tuple<ContinentFilterInput> args) const {
    return m_continents.at(args);
  }
  void set_continents(const std::vector<std::shared_ptr<Continent>> &v,
                      std::tuple<ContinentFilterInput> args) {
    m_continents[args] = v;
...
class State : public qtgql::bases::ObjectTypeABC {
  Q_OBJECT
public:
  QString m_code = qtgql::bases::DEFAULTS::STRING;
...
public:
  [[nodiscard]] const QString &get_code() const { return m_code; }
